...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Enqueue was inserting items at the beginning of the queue instead of adding it at the end of the queue.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: GetNextPerson was not adding people with 0 turns (infinite turn) back into the queue.
    ...
    // Defect(s) Found: GetNextPerson was not adding people with negative turns (infinite turn) back into the queue.
